...
https://rstudio.github.io/academy-pinr-heart-catheterization/assets/heart-report.html
...
Using the File Explorer, navigate to the `images/` directory, then click on `image_04.png` to open an image. **Your plots should match this one.**

## Part 2 - Report

Next, use the functions in `heart-catheterization_04_loops.R` to recreate [this Quarto report](https://rstudio.github.io/academy-pinr-heart-catheterization/assets/heart-report.html
